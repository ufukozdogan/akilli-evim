...
public class SicaklikSorguAltPaneli extends javax.swing.JFrame {

    public SicaklikSorguAltPaneli() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        baslik.setText("Ölçülen Sıcaklık Tarihleri");
        ...
        getContentPane().add(arkaplan, new org.netbeans.lib.awtextra.AbsoluteConstraints(-640, -120, -1, -1));
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new SicaklikSorguAltPaneli().setVisible(true);
            }
        });
    }
